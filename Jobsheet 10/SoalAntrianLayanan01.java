...
public class SoalAntrianLayanan01 {
    private LinkedList<SoalMahasiswa01> queue;
    private int maxAntrian;
    private int jumlahKRS;

    public SoalAntrianLayanan01(int maxAntrian) {
    ...
    public void addAntrian(SoalMahasiswa01 mhs) {
        if (!isFull()) {
            queue.add(mhs);
